            ...
            if($this->request->method == "POST") {
                ...
                switch($this->request->query->formType) {
                    ...
                    case "send":
                        ...
                        $response          = $bulkReaction->like($bayiIslem["mediaID"], $bayiIslem["mediaCode"]);
                ...
                switch($this->request->query->formType) {
                    ...
                    case "send":
                        ...
                        if(!($bayiIslemID > 0)) {
                            ...
                            echo "INSERT INTO bayi_islem (bayiID,islemTip,mediaID,mediaCode,userID,userName,imageUrl,krediTotal,krediLeft,gender,likedComment,likedCommentID) VALUES(:bayiID,:islemTip,:mediaID,:mediaCode,:userID,:userName,:imageUrl,:krediTotal,:krediLeft,:gender,:likedComment,:likedCommentID)";
