...
//            $consent = $this->instagramReaction->objInstagram->consentSend();
//
//            echo "<pre>",print_r($consent),"</pre>";exit();
        ...
        function FollowAction() {
            ...
            $this->instagramReaction->objInstagram->follow($this->request->data->id);
        ...
        function UploadImageAction() {
            ...
            if($this->request->files->file["error"] === UPLOAD_ERR_OK) {
                ...
                if($info === FALSE) {
                    ...
                    if(($info[2] !== IMAGETYPE_JPEG) && ($info[2] !== IMAGETYPE_PNG)) {
                        ...
                        $sonuc = $this->instagramReaction->objInstagram->uploadPhoto($this->request->files->file["tmp_name"], $this->request->data->aciklama);
                        if($sonuc["status"] != "ok") {
                            $uploadError = "Instagram yüklediğiniz resmi kabul etmedi! Yükleyeceğiniz resimler 4:4, 4:3, 4:2 vb. landscape oranlarında olmalıdır!";
                        }
                    }
                }
            } else {
            ...
            if(!is_null($uploadError)) {
                ...
                $objNotification->title      = "Resim Eklendi.";
                $objNotification->messages[] = "Resim başarılı bir şekilde eklendi.";
            }
        ...
        function UploadImageFromUrlAction() {
            $uploadError = NULL;
            ...
            if($info === FALSE) {
                ...
                if(($info[2] !== IMAGETYPE_JPEG) && ($info[2] !== IMAGETYPE_PNG)) {
                    ...
                    $sonuc = $this->instagramReaction->objInstagram->uploadPhoto($this->request->data->url, $this->request->data->aciklama);
                    if($sonuc["status"] != "ok") {
                        $uploadError = "Instagram yüklediğiniz resmi kabul etmedi! Yükleyeceğiniz resimler 4:4, 4:3, 4:2 vb. landscape oranlarında olmalıdır!";
                    }
                }
