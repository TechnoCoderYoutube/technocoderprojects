...
<form method="post" class="form-horizontal">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            ...
            <span class="help-block">Video görüntülenmenin sitede görünme ayarıdır. Sistemde video görüntülenmeyi aktif etmek için smm paneline girip aktifleştirmeniz gerekmektedir.<br/><a href="/admin/api-smm">SMM Sistemine Git</a>.</span>
        </div>
    </div>
    <div class="clearfix"></div>
    <div class="form-group">
        ...
        <div class="col-sm-10">
            ...
            <span class="help-block">Resim kaydetme özelliğinin sitede görünme ayarıdır. Sistemde video görüntülenmeyi aktif etmek için smm paneline girip aktifleştirmeniz gerekmektedir.<br/><a href="/admin/api-smm">SMM Sistemine Git</a>.</span>
        </div>
    </div>
    <div class="form-group">
        <label class="col-sm-2 control-label">SMM Url ve Key</label>
        <div class="col-sm-10">
            <input type="text" class="form-control" name="ayar[smmUrl]" value="<?php echo Wow::get("ayar/smmUrl"); ?>">
            <span class="help-block">Eğer apinizi smm üzerinden çalıştıracaksanız buraya smm urlnizi ve api keyinizi girmeniz gerekmektedir. örn: http://smmlite.com/api/v2?key=sa7da4sd7asd417111a45q4<br/><a href="/admin/api-smm">SMM Sistemine Git</a>.</span>
        </div>
    </div>
    <div class="clearfix"></div>
    <div class="form-group">
        <label class="col-sm-2 control-label">Oto Proxy</label>
        <div class="col-sm-10">
            <select class="form-control" id="otoProxy" name="ayar[otoProxy]" required>
                <option value="0" <?php echo Wow::get("ayar/otoProxy") == 0 ? "selected" : ""; ?>>Pasif</option>
                <option value="1" <?php echo Wow::get("ayar/otoProxy") == 1 ? "selected" : ""; ?>>Aktif</option>
            </select>
            <span class="help-block">Oto proxy sisteminin aktif olması için smm sistemine giriş yapmış olmanız gerekmektedir.<br/><a href="/admin/api-smm">SMM Sistemine Git</a>. Oto proxy sistemi ile sunucunuza tanımlanan proxy adresi dakikada 1 değişmektedir.</span>
        </div>
    </div>
    <div class="clearfix"></div>
